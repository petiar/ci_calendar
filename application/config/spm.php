...
// $config['spm_calendar_id'] = 'participatorymedicine.org_h998jekm9hj03fb8h567iklo90@group.calendar.google.com'; // production calendar
$config['spm_calendar_id'] = 'emailcentral@participatorymedicine.org'; // dev test public calendar
// $config['spm_developer_key'] = 'AIzaSyCxgHQ4b423qsoWkIADcjRmvRTWXvZTguc';
$config['spm_developer_key'] = 'AIzaSyBrvyU3sY0wo5CCROVmTa4yXeIELEdpbTY';
